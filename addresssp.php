...
<body>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            ...
            <form class="text-white border-white shadow custom-form" action="addsp.php" name="form" onsubmit="return validateForm();" method="post">
       <div class="col">
   ...
   <input  class="form-control" type="text" name="inputCity" style="font-family: Asap, sans-serif; width:250px;" placeholder="Enter The City!"><span id="cityerror"></span>
    ...
    <div class="form-group"><input class="form-control" type="text" name="suburb" id="suburb" placeholder="Suburb" style="font-family: Asap, sans-serif;"><span id="suberror"></span></div>

        <div class="form-group"><input class="form-control" type="text" name="standno" id="standno" placeholder="Stand No." style="font-family: Asap, sans-serif;"><span id="standerror"></div>
        <div class="form-group"><input class="form-control" type="text" name="streetname" id="streetname" placeholder="Street Name" style="font-family: Asap, sans-serif;"><span id="streeterror"></span></div>
        
        
      
         <button class="btn btn-light btn-block btn-sm submit-button" name="add" type="submit" style="background-color: rgb(240,62,51);font-weight: normal;font-family: Asap, sans-serif;font-size: 16px;">Add</button></form>
        </div>
        </div>
