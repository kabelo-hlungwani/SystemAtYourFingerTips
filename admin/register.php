...
<body>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            ...
            <form class="text-white border-white shadow custom-form" action="addAccount.php" name="form" onsubmit="return validateForm();" method="post">
                <div class="col">
                    <h1 style="font-size: 16px;font-family: Asap, sans-serif;color: rgb(240,62,51);font-style: italic;">Personal Details Form </h1>
                </div>
                <hr style="background-color: #f03e33;">
                <div class="form-group"><input class="form-control" type="text" name="name" id="name" placeholder="Firstname" style="font-family: Asap, sans-serif;"><span id="nerror"></span></div>
                <div class="form-group"><input class="form-control" type="text" name="surname"  id="surname" placeholder="Lastname" style="font-family: Asap, sans-serif;"><span id="serror"></span></div>
                <div class="form-group"><input class="form-control" type="text"  name="dob"  id="dob" placeholder="Date Of Birth" onfocus="(this.type='date')" max="2002-12-31" min="1960-01-31" style="font-family: Asap, sans-serif;"><span id="doberror"></span></div>
                <div class="form-group">
                <div>
                        <div class="input-group">
                            <div class="input-group-prepend"></div>
                            <input class="border rounded form-control" type="text" maxlength="6" name="dob1" id="dob1"  placeholder="Date Of Birth" readonly="" style="background-color: rgba(240,62,51,0.33);">
                            <input class="border rounded form-control" type="text" id="idno" name="idno" maxlength="7" placeholder="Complete Id Number"><br><span id="iderror"></span>
                           </div>
                    </div>
                </div><br>
                <div class="form-group"><input class="form-control" type="text"  name="gender"   maxlength="13" id="gender" placeholder="Gender" readonly="" style="font-family: Asap, sans-serif;">
                </select><span id="gerror"></div>
                
                <div
                    class="form-group"><input class="form-control" type="email" name="email" id="email" placeholder="Email" style="font-family: Asap, sans-serif;"><span id="error"></span></div>
        <div class="form-group"><input class="form-control" type="text" name="cellno" id="cellno" placeholder="Phone number" style="font-family: Asap, sans-serif;"><span id="cerror"></span></div>
       
        <div
            class="col">
            <h1 style="font-size: 16px;font-family: Asap, sans-serif;color: rgb(240,62,51);font-style: italic;">Account Login Details</h1>
            <hr style="background-color: #f03e33;">
    </div>
    <div class="form-group">
                <label style="font-size: 16px;font-family: Asap, sans-serif;color: rgb(240,62,51);">Admin&nbsp;</label><input type="radio" name="accounttype" value="Client">
                
                <br><span id="accounttypeerror"></span></div>
