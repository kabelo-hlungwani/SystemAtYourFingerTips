...
<body >
    ...
    <h2 class="text-center  " style="font-family: Asap, sans-serif;font-weight: normal;color: rgb(240,62,51);">Made Booking(s) </h2>
    <?PHP
              ...
              *
          FROM
              booking,service,booking_details,payment
              WHERE service.service_id=booking_details.service_id
              AND booking.status='0'
              AND payment.booking_id=booking.booking_id
              AND booking.booking_id=booking_details.booking_id
            ...
            <table class="table">
                ...
                <?php
                    while ($rows=mysqli_fetch_array($result)) {
                        ...
                        if($rows['totAmount']==$rows['balAmount'])
                        {
                           ...
                           $hide= "Balance Settled.";
        
                        }else
                        {
                           $hide= "Outstanding Balance.".' R'.number_format($diff,2);
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="slips.php?edt=<?php echo $rows['booking_id'];?>"><i class="fa fa-eye" title="View Booked Items" style="color: rgb(235,50,50);font-size: 22px;"></i></a></td>
                        <td style="color: rgb(235,50,50);"><strong><?php echo $hide ?></strong></td>
