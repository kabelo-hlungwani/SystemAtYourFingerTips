...
<body>
    ...
    <div class="container">
        <h1 style="font-size: 30px;color: rgb(240,62,51);">Chairs Available</h1>
        ...
        <?php
            ...
            <div class="col-12 col-sm-6">
                ...
                ?>
                <br>
                <h2 style="color: rgb(240,62,51);font-size: 18px;text-align:center;">No Chairs to Hire at the moment.</h2>
                <?php
              } ?>
    </div>
    </div>
