...
<body style="font-family: 'Advent Pro', sans-serif;">
    ...
    <select   onchange="location=this.value;" style="height:35px;font-family: Asap, sans-serif;">
        ...
        <option  style="font-family: Asap, sans-serif;" value="">Daily Report</option>
    ...
    <div class="col" style="font-family: Asap, sans-serif;padding-top: 21px;">
        <h1 class="text-center" style="color: rgb(240,62,51);font-size: 26px;">Daily reports</h1>
    </div>
    ...
    <?PHP
          ...
          AND date_Format(booking.booking_date,'%d-%M-%Y')=date_Format(sysdate(),'%d-%M-%Y')
