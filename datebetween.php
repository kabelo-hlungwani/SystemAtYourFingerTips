...
<body style="font-family: 'Advent Pro', sans-serif;">
    <div>
        ...
        <option style="font-family: Asap, sans-serif;" value="(payment.qty)">Quantity </option>
        <option style="font-family: Asap, sans-serif;" value="(payment.total_amount)">Amount Paid</option>
    ...
    <div class="col" style="font-family: Asap, sans-serif;padding-top: 21px;">
        <h1 class="text-center" style="color: rgb(240,62,51);font-size: 26px;">Report between ( <?php echo $datebegan; ?> and <?php echo $lastdate; ?> )</h1>
    </div>
    ...
    <?PHP
          ...
          AND date_Format(booking.booking_date,'%d-%m-%Y') BETWEEN '$newdate' AND '$ldate'
