...
<body>
    ...
    <div class="container">
        <h1 style="font-size: 30px;color: rgb(240,62,51);">Mobile Refridgerator Available</h1>
        ...
        <?PHP
              ...
              WHERE service_type='Mobile Refridgerator';";
        ...
        <?php
            ...
            <div class="col-12 col-sm-6">
                ...
                ?>
                <br>
                <h3 style="color: rgb(240,62,51);font-size: 18px;text-align:center;">No Mobile Refridgerator  to Hire at the moment.</h3>
                <?php
              } ?>
    </div>
    </div>
