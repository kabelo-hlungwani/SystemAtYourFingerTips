...
<body>
    ...
    <div class="container">
        <h1 style="font-size: 30px;color: rgb(240,62,51);">Hall(s) Available</h1>
        ...
        <?php
            ...
            <div class="col-12 col-sm-6">
                ...
                ?>
                <br>
                <h3 style="color: rgb(240,62,51);font-size: 18px;text-align:center;">No Hall to Hire at the moment.</h3>
                <?php
              } ?>
    </div>
    </div>
