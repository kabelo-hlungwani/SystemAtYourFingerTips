...
<body>
            ...
            <div class="container"><a class="navbar-brand" href="index.php" style="font-family: Asap, sans-serif;font-weight: normal;">SAYFT&nbsp;<i class="fa fa-calendar"></i>&nbsp;</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto" style="color: rgb(255,255,255);">
                        <li class="nav-item" role="presentation"><a class="nav-link" href="index.php" style="color: rgb(255,255,255);font-weight: normal;font-family: Asap, sans-serif;"><i class="fa fa-home"></i>&nbsp;Home&nbsp;</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="login-admin.php" style="color: rgb(255,255,255);font-family: Asap, sans-serif;"><i class="fa fa-laptop"></i>&nbsp;Adminstration&nbsp;</a></li>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            <h2 class="text-center shadow-sm form-heading" style="font-family: Asap, sans-serif;font-weight: normal;color: rgb(240,62,51);">Admin Login Form&nbsp;<i class="fa fa-briefcase"></i></h2>
            <form class="text-white border-white shadow custom-form" autocomplete="off" action="adminLog.php" name="form" onsubmit="return validateForm();" method="post">
                <div class="col">
                    <h1 style="font-size: 16px;font-family: Asap, sans-serif;color: rgb(240,62,51);font-style: italic;">Provide Login Details</h1>
                    <hr style="background-color: #f03e33;">
                </div>
                <div class="form-group"><input class="form-control" type="text" name="email" id="email" placeholder="Email" style="font-family: Asap, sans-serif;"><span id="uerror"></span></div>
                <div class="form-group"><input class="form-control" type="password" id="password" name="password" placeholder="Password" style="font-family: Asap, sans-serif;"><span id="perror"></span></div>
                <button class="btn btn-light btn-block btn-sm submit-button" type="submit" style="background-color: rgb(240,62,51);font-weight: normal;font-family: Asap, sans-serif;font-size: 16px;">Login</button>
                <br>
                <a href="adminpasswordRecover.php" style="color: rgb(240,62,51);font-family: Asap, sans-serif;">Forgot your password?Click here!</a>
            </form>
        </div>
    </div>
