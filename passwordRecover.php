...
<script>
        ...
        if(document.forms["form"]["email"].value=="" && document.forms["form"]["accounttype"].value=="")
        {
...
<body>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            <h2 class="text-center shadow-sm form-heading" style="font-family: Asap, sans-serif;font-weight: normal;color: rgb(240,62,51);">Password Recovery&nbsp;<i class="fa fa-unlock-alt"></i></h2>
            <form class="text-white border-white shadow custom-form" action="checkemail.php" name="form" onsubmit="return validateForm();" method="post">
                <div class="col">
                ...
                <div class="form-group"><select class="form-control" id="accounttype" name="accounttype" style="font-family: Asap, sans-serif;">
                ...
                <div
                    class="form-group"><input class="form-control" type="email" id="email" name="email" placeholder="Email" style="font-family: Asap, sans-serif;"><span id="uerror"></span></div>
               
                    <button class="btn btn-light btn-block btn-sm submit-button" value="submit" name="submit" type="submit" style="background-color: rgb(240,62,51);font-weight: normal;font-family: Asap, sans-serif;font-size: 16px;">Submit</button>
