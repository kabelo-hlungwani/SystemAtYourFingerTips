...
<script>
        ...
        if(document.forms["form"]["servicetype"].value=="")
        {
        ...
        else
        {
            ...
            var accounttype=document.forms["form"]["servicetype"].value;
...
<body>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            <h2 class="text-center shadow-sm form-heading" style="font-family: Asap, sans-serif;font-weight: normal;color: rgb(240,62,51);">Search Service&nbsp;</h2>
            <form class="text-white border-white shadow custom-form" action="searchedadverts.php" name="form" onsubmit="return validateForm();" method="post">
                <div class="col">
                    <h1 style="font-size: 16px;font-family: Asap, sans-serif;color: rgb(240,62,51);font-style: italic;">Search the service you desire to book.</h1>
                    ...
                    <div class="form-row padMar">
                        <div class="col padMar">
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend"></div><select id="servicetype" name="servicetype" class="input-group-prepend" style="font-family: Asap, sans-serif;text-align: center;">
                                ...
                                &nbsp;<div class="input-group-append"><button class="btn btn-warning border-white" type="submit" style="background-color: rgb(240,62,51);color: rgb(255,255,255);"><i class="fa fa-search"></i></button></div>
                               
                            </div> <span id="accounttypeerror"></span>
                        </div>
                    </div>
        </div><a href="profileDash.php" style="color: rgb(240,62,51);font-family: Asap, sans-serif;">Back</a></form>
    </div>
    </div>
