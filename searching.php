...
<body style="font-family: 'Advent Pro', sans-serif;">
    ...
    <select   onchange="location=this.value;" style="height:35px;font-family: Asap, sans-serif;">
        ...
        <option  style="font-family: Asap, sans-serif;" value="monthly.php">Monthly Report</option>
    </select>
    ...
    <div class="col" style="font-family: Asap, sans-serif;padding-top: 21px;">
        <h1 class="text-center" style="color: rgb(240,62,51);font-size: 26px;">Information Searched </h1>
    </div>
    ...
    <?PHP
              ...
              if($field=="")
              {
                ...
                $query="SELECT booking.booking_id as bid,user.user_id as aid,user.name as name,user.surname as surname,user.email as email,user.id_number as idn,
                user.phone_number as numbers,user.gender as gen,
                location.stand_no as sno,location.street_name as sname,location.suburb as sub,location.city as city,location.province as prov,service.service_type as serv,booking.booking_date as bdate
                ,service.description as descr,payment.payment_type as paytype,service.image as image,
                payment.qty as qty,payment.totamount as full
                FROM user,booking,service,payment,location
                WHERE booking.booking_id=payment.booking_id
                AND booking.user_id=user.user_id
                AND location.user_id=user.user_id
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td style="font-family: Asap, sans-serif;"><?php echo $rows['bid'];?></td>
                                            ...
                                            <td style="font-family: Asap, sans-serif;"><?php echo $rows['price'];?></td>
