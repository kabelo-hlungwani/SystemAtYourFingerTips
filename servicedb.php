...
<body style="font-family: 'Advent Pro', sans-serif;">
            ...
            <div class="container"><a class="navbar-brand" href="index.html" style="font-family: Asap, sans-serif;font-weight: normal;">&nbsp;<i class="fa fa-dashboard"></i>&nbsp;</a><a class="navbar-brand" href="#" style="font-family: Asap, sans-serif;font-weight: normal;">Logged In as <i class="fa fa-user"></i>&nbsp;<?php echo($data2['surname']." ".$data2['name']) ?>&nbsp;</a>
                <button
                    ...
                    <ul class="nav navbar-nav flex-grow-1 justify-content-between">
                        <li class="nav-item" role="presentation"><a class="nav-link border rounded-0" href="clientdb.php" style="color: rgb(255,255,255);font-family: Asap, sans-serif;">Clients Accounts</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link border rounded-0 border-white active" href="servicedb.php" style="font-family: Asap, sans-serif;color: rgb(255,255,255);">Service Providers Accounts</a></li>
    ...
    <div class="col" style="font-family: Asap, sans-serif;padding-top: 21px;">
        <h1 class="text-center" style="color: rgb(240,62,51);font-size: 26px;">Service Provider Accounts</h1>
    </div>
            ...
            <table id="page-content" class="table table-striped table-sm my-0 mydatatable" style="font-size: 12px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="spupdate.php?edt=<?php echo $rows['id'];?>" style="color: rgb(240,62,51);line-height: 24px;font-size: 24px;"><i class="fa fa-edit"></i></a></td>
                        <td><a href="deletesp.php?edt=<?php echo $rows['id'];?>"><i class="fa fa-trash" style="color: rgb(240,62,51);font-size: 24px;"></i></a></td>
                    </tr><?php
