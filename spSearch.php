...
<body>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            ...
            <form class="text-white border-white shadow custom-form" action="spads.php" name="form" onsubmit="return validateForm();" method="post">
                <div class="col">
        ...
        </div><a href="sprofileDash.php" style="color: rgb(240,62,51);font-family: Asap, sans-serif;">Back</a></form>
    </div>
    </div>
