...
<body style="font-family: 'Advent Pro', sans-serif;">
    ...
    <div class="form-row">
        <div class="col-md-6">
            <div class="dropdown btn-group" role="group">
                        ...
                        <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" role="presentation" href="updateServiceP.php?edt=<?php echo $rows['email'];?>">Update Personal Details</a>
                           
                          
                            <a class="dropdown-item" <?php echo $none;?> role="presentation"href="addresssp.php?edt=<?php echo $rows['user_id'];?>">Add Address</a>

                     
                            <a class="dropdown-item" role="presentation"href="addressviewsp.php">View Address</a>
          <a class="dropdown-item" role="presentation"href="deleteServiceP.php?edt=<?php echo $rows['email'];?>">Delete Account</a>
        ...
        <div class="col-md-6">
        <div class="dropdown btn-group" role="group">
                        <button class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: rgb(240,62,51);color: rgb(255,255,255);">Service Options</button>
                        <div class="dropdown-menu" role="menu">
                       
                            <a class="dropdown-item" role="presentation" href="addservice.php?edt=<?php echo $rows['user_id'];?>">Add Services</a>
                   

                            <a class="dropdown-item" role="presentation" href="MyAdvertView.php?edt=<?php echo $rows['email'];?>" >View Added Service</a>
                            <a class="dropdown-item" role="presentation" href="bookingsdone.php">View Booking</a>
                            <a class="dropdown-item" role="presentation"  href="spdb.php">View Service Providers</a>
                          
                            <a class="dropdown-item"  role="presentation" href="spSearch.php">Check Service(s)</a>
                            <a class="dropdown-item"  role="presentation" href="spreport.php?edt=<?php echo $rows['user_id'];?>">Service Management</a>
