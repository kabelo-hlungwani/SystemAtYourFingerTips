...
<body>
        ...
        <form class="search-form">
            ...
            <div class="input-group-prepend"><span class="input-group-text" style="color: rgb(240,62,51);background-color: rgb(255,255,255);"><i class="fa fa-list-alt"></i></span>
                    <div class="dropdown btn-group" role="group"><button class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: rgb(240,62,51);color: rgb(255,255,255);">Category Navigator</button>
                        <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="chairs.php">Chairs</a><a class="dropdown-item" role="presentation" href="tables.php">Tables</a><a class="dropdown-item" role="presentation" href="drinks.php">Drinks</a><a class="dropdown-item" role="presentation"
    ...
    <div class="container">
        <h1 style="font-size: 30px;color: rgb(240,62,51);">Tables Available</h1>
        ...
        <?php
            ...
            <div class="col-12 col-sm-6">
                ...
                ?>
                <br>
                <h3 style="color: rgb(240,62,51);font-size: 18px;text-align:center;">No Tables to Hire at the moment.</h3>
                <?php
              } ?>
    </div>
    </div>
