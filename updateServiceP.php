...
echo '<script>alert("Information Updated.");window.location = "sprofileDash.php";</script>';
...
<body>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            ...
            <form class="text-white border-white shadow custom-form" action="" name="form" onsubmit="return validateForm();"  method="post">
                ...
                <div class="form-group"><input class="form-control" id="idno" type="text"  value="<?php echo $data['id_number']?>" readonly="" name="idno" placeholder="id number" style="font-family: Asap, sans-serif;"><span id="iderror"></span></div>
    ...
    <div class="form-group"><input class="form-control" type="text" name="accounttype" readonly=""  value="<?php echo $data['account_type']?>" placeholder="account type" style="font-family: Asap, sans-serif;"></div>        
