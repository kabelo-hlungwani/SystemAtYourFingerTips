...
$qry=mysqli_query($conn,"select * from location WHERE user_id='$id'");
...
$command="UPDATE  location
 SET province='$province', city='$inputCity',suburb='$suburb', street_name='$streetname', stand_no='$standno'
 WHERE user_id='$id'";
    ...
    }else
    {
        ...
        $command="UPDATE  location
        SET province='$province', city='$city',suburb='$suburb', street_name='$streetname', stand_no='$standno'
        WHERE user_id='$id'";
...
echo '<script>alert("Information Updated.");window.location = "addressviewsp.php";</script>';
...
<body>
            ...
            <div class="container"><a class="navbar-brand" href="index.php" style="font-family: Asap, sans-serif;font-weight: normal;">SAYFT&nbsp;<i class="fa fa-calendar"></i>&nbsp;</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto" style="color: rgb(255,255,255);">
                        <li class="nav-item" role="presentation"><a class="nav-link" href="sprofileDash.php" style="color: rgb(255,255,255);font-weight: normal;font-family: Asap, sans-serif;">&nbsp;Back&nbsp;</a></li>
    ...
    <div class="row login-form">
        <div class="col-md-4 offset-md-4" style="padding-top: 131px;">
            <h2 class="text-center shadow-sm form-heading" style="font-family: Asap, sans-serif;font-weight: normal;color: rgb(240,62,51);">Address Form &nbsp;<i class="fa fa-pencil"></i></h2>
       ...
       <div class="col">
        ...
        <div class="form-group"><select class="form-control" name="province" value="<?php echo $data['province']?>" id="province" style="font-family: Asap, sans-serif;" onchange="javascript:countryChange()">
    ...
    <div class="form-group"><select  class="form-control" name="city" value="<?php echo $data['city']?>"  style="display: none;font-family: Asap, sans-serif;" id="city">
    </select></div>
   ...
   <input  class="form-control" type="text" name="inputCity" style="font-family: Asap, sans-serif; width:250px;" placeholder="Enter The City!"><span id="cityerror"></span>
    ...
    <div class="form-group"><input class="form-control" type="text" value="<?php echo $data['suburb']?>" name="suburb" id="suburb" placeholder="Suburb" style="font-family: Asap, sans-serif;"><span id="suberror"></span></div>

        <div class="form-group"><input class="form-control" type="text" value="<?php echo $data['stand_no']?>" name="standno" id="standno" placeholder="Stand No." style="font-family: Asap, sans-serif;"><span id="standerror"></div>
        <div class="form-group"><input class="form-control" type="text" name="streetname" value="<?php echo $data['street_name']?>" id="streetname" placeholder="Street Name" style="font-family: Asap, sans-serif;"><span id="streeterror"></span></div>
        
         <button class="btn btn-light btn-block btn-sm submit-button" name="update" type="submit" style="background-color: rgb(240,62,51);font-weight: normal;font-family: Asap, sans-serif;font-size: 16px;">Update</button></form>
        </div>
        </div>
