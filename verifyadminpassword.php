...
$query="select * from admin where email='$email'and phone_number='$cellno'";
...
if($row['email']==$email && $row['phone_number']==$cellno)
{
    ...
    echo '<script>alert("Information password Updated.");window.location = "login-admin.php";</script>';
...
}else
{
    ...
    require 'changeadminpassword.php'; 
