...
<body style="font-family: 'Advent Pro', sans-serif;">
    <div>
        ...
        <option style="font-family: Asap, sans-serif;" value="(user.stand_no)">stand no</option>
        <option style="font-family: Asap, sans-serif;" value="(user.street_name)">Street Name </option>
        <option style="font-family: Asap, sans-serif;" value="(user.suburb)">Suburb </option>
        <option style="font-family: Asap, sans-serif;" value="(user.city)">City </option>
        <option style="font-family: Asap, sans-serif;" value="(user.province)">Province </option>
    ...
    <select   onchange="location=this.value;" style="height:35px;font-family: Asap, sans-serif;">
        ...
        <option  style="font-family: Asap, sans-serif;" value="">Weekly Report</option>
        <option  style="font-family: Asap, sans-serif;" value="monthly1.php">Monthly Report</option>
    </select>
    ...
    <div class="col" style="font-family: Asap, sans-serif;padding-top: 21px;">
        <h1 class="text-center" style="color: rgb(240,62,51);font-size: 26px;">Weekly reports</h1>
    </div>
    ...
    <?PHP
          ...
          AND booking_details.service_id=service.service_id
              AND YEARWEEK(booking.booking_date)=YEARWEEK(sysdate())
